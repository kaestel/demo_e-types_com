		...
		if(u.hc(page, "i:page")) {
			...
			page.resetHeight = function() {
				...
				if(navigator.userAgent.match(/iphone|ipod/i)) {
					if(u.gcs(this, "height") != "4000px") {
						...
						if(h < page.cN.offsetHeight) {
							u.a.setHeight(document.body, "auto");
						}
						else {
			...
			page.orientationchanged = function(event) {
				if(!page.killed) {
					...
					page.force_update = function() {
						location.href = location.protocol+"//"+document.domain+"/#"+page.cN.request_url;
						location.reload(true);
					}
					u.t.setTimer(page, page.force_update, 1000);
					page.killed = true;
				}
			}
			page.ready = function() {
				...
				if(!u.hc(this, "ready")) {
					if(!u.hc(document.body, "standalone")) {
						this.resetHeight();
					}
			...
			page.cN.ready = function() {
				if(!page.intro && u.hc(page, "ready") && u.hc(this, "ready")) {
					...
					else if(!this.scene.built && this.scene && typeof(this.scene.build) == "function") {
			...
			page.cN.navigate = function(url) {
				...
				this.response = function(response) {
					...
					u.setClass(document.body, response.body_class + (u.hc(document.body, "standalone") ? " standalone": ""));
					document.title = response.head_title;
					page.hN.page_title.innerHTML = response.head_title;
					var scene = u.qs(".scene", response);
					this.scene = u.ae(this, scene);
					u.init(this.scene);
					u.init(this);
					u.ac(this, "ready");
					this.ready();
			...
			page.initHeader = function() {
				page.hN.bn_nav = u.qs("li.navigation", page.hN);
				page.hN.bn_nav.clicked = function(event) {
					...
					if(!u.hc(page.nN, "open")) {
						...
						u.as(page.hN.page_title, "display", "none");
						u.ac(page.nN, "open");
					}
					else {
						u.a.setOpacity(page.cN, 1);
						u.a.transition(page.nN, "all 0.3s ease-in-out");
						u.a.translate(page.nN, 0, -(page.nN.offsetHeight+page.hN.offsetHeight));
						u.as(page.hN.page_title, "display", "block");
						u.rc(page.nN, "open");
					}
				}
				u.ce(page.hN.bn_nav);
			...
			page.initNavigation = function() {
				page.hN.page_title = u.ae(page.hN, "div", {"class": "page_title"});
				page.hN.ul = u.qs("ul", page.nN);
				u.ie(page.hN.ul, u.qs(".servicenavigation li.contact", page.hN));
				u.ie(page.hN.ul, u.qs(".servicenavigation li.welcome", page.hN));
				var i, node;
				var nodes = u.qsa("ul li", page.nN);
				for(i = 0; node = nodes[i]; i++) {
					if(!u.qs("a", node).target) {
						node.moved = function(event) {
							u.e.resetEvents(this);
						}
						node.clicked = function(event) {
							u.e.kill(event);
							page.navigate(this.url, page.nN);
							page.hN.bn_nav.clicked();
						}
						u.ce(node);
					}
				...
				u.a.translate(page.nN, 0, -(page.nN.offsetHeight+page.hN.offsetHeight));
				u.e.drag(page.nN, [0, window.innerHeight-(page.nN.offsetHeight+page.hN.offsetHeight), page.nN.offsetWidth, page.nN.offsetHeight], {"strict":false});
			}
...
Util.Objects["front"] = new function() {
	this.init = function(scene) {
		...
		scene.scrolled = function() {
			if (this.nodes && this.nodes.length) {
				...
				for(i = 0; node = this.nodes[i]; i++) {
					if(u.absY(node) < u.scrollY() + u.browserH() + 400 && !u.hc(node, "ready")) {
						this.buildNode(node);
					}
				}
			}
		...
		scene.build = function() {
			...
			u.a.transition(this, "none");
			u.a.setOpacity(this, 1);
			this.nodes = u.qsa(".news li", this);
			var i, node;
			for(i = 0; node = this.nodes[i]; i++) {
				node._info = u.qs(".info", node);
				if (node._info) {
					node._info.unit = u.qs("dd.unit", node);
					node._info.unit.innerHTML += "&nbsp;&nbsp;/&nbsp;";
					u.ie(node, node._info);
				}
		...
		scene.buildNode = function(node) {
			...
			node.loaded = function(queue) {
				u.bug("src: " + queue[0]._image.src);
				u.ie(this, "img", {"src": queue[0]._image.src});
			}
			u.preloader(node, ["/images/"+u.cv(node, "item_id")+"/landscape/320x."+u.cv(node, "i_la")]);
		}
		scene.destroy = function() {
...
Util.Objects["news"] = new function() {
	this.init = function(scene) {
		...
		scene.build = function() {
			...
			u.a.transition(this, "none");
			u.a.setOpacity(this, 1);
			this.nodes = u.qsa("ul.news li.item", this);
			var i, node;
			for(i = 0; node = this.nodes[i]; i++) {
				node._info = u.qs(".info", node);
				if (node._info) {
...
Util.Objects["article"] = new function() {
	this.init = function(scene) {
		...
		scene.build = function() {
			u.a.transition(this, "none");
			u.a.setOpacity(this, 1);
			this.node = u.qs(".item", this);
			this.node._info = u.qs(".info", this.node);
			if (this.node._info) {
				this.node._info.unit = u.qs("dd.unit", this.node);
				this.node._info.unit.innerHTML += "&nbsp;&nbsp;/&nbsp;";
				this.node._info.client = u.qs("dd.client", this.node);
				this.node._info.client.innerHTML += "&nbsp;&nbsp;/&nbsp;";
			}
			this.node.loaded = function(queue) {
				u.bug("src: " + queue[0]._image.src);
				u.ie(this, "img", {"src": queue[0]._image.src});
			}
			u.preloader(this.node, ["/images/"+u.cv(this.node, "item_id")+"/landscape/320x."+u.cv(this.node, "i_la")]);
		}
		scene.destroy = function() {
			this.destroy = null;
			this.transitioned = function() {
...
Util.Objects["about"] = new function() {
	this.init = function(scene) {
		...
		scene.build = function() {
			...
			u.a.transition(this, "none");
			u.a.setOpacity(this, 1);
			this.about = u.qs(".about", this);
			this.theway = u.qs(".theway", this);
			this.deco1 = u.ie(this.about, "div", {"class":"deco deco1"});
			...
			this.deco2 = u.ae(this.theway, "div", {"class":"deco deco2"});
			this.deco2.scene = this;
			this.deco2._img = u.ae(this.deco2, "img");
			this.deco2._src = "/img/desktop/about_4.jpg";
			u.ae(this.deco2, "p", {"html":"Vesterbrogade 80B, 1620"});
			this.deco_i = 1;
...
Util.Objects["competences"] = new function() {
	this.init = function(scene) {
		...
		scene.build = function() {
			...
			u.a.setOpacity(this, 1);
			this.theway = u.qs(".theway", this);
			this.ul = u.qs("ul", this);
			this.theway = u.ie(this.ul, this.theway);
			this.deco1 = u.ie(this, "div", {"class":"deco deco1"});
			this.deco1.scene = this;
			this.deco1._img = u.ae(this.deco1, "img");
			...
			this.deco2.scene = this;
			this.deco2._img = u.ae(this.deco2, "img");
			this.deco2._src = "/img/desktop/competences_3.jpg";
			u.ae(this.deco2, "p", {"html":"Mads Lynneryp, If you see something interesting... , 2007"});
			this.deco_i = 1;
			this.loadDeco = function(queue) {
				if(this.deco_i <= 2) {
					u.preloader(this["deco"+this.deco_i], [this["deco"+this.deco_i]._src], {"callback":this._decoReady});
...
/*i-playtype-smartphone.js*/
Util.Objects["playtype"] = new function() {
	this.init = function(scene) {
		scene.resized = function() {
			var top = (this.offsetWidth/this.aspect)-40;
			u.as(this.actions, "padding-top", top+"px");
		}
		scene.ready = function() {
			u.ac(this, "ready");
			u.ac(page.cN, "ready");
		...
		scene.build = function() {
			...
			u.a.transition(this, "none");
			u.a.setOpacity(this, 1);
			this.love = u.qs(".love", this);
			this.store = u.qs(".store", this);
			this.deco1 = u.ae(this.love, "div", {"class":"deco deco2"});
			this.deco1.scene = this;
			this.deco1._img = u.ae(this.deco1, "img");
			this.deco1._src = "/img/desktop/playtype_2.jpg";
			this.deco2 = u.ae(this.love, "div", {"class":"deco deco3"});
			this.deco2.scene = this;
			this.deco2._img = u.ae(this.deco2, "img");
			this.deco2._src = "/img/desktop/playtype_3.jpg";
			this.deco3 = u.ae(this.store, "div", {"class":"deco deco4"});
			this.deco3.scene = this;
			this.deco3._img = u.ae(this.deco3, "img");
			this.deco3._src = "/img/desktop/playtype_4.jpg";
			this.deco4 = u.ae(this.store, "div", {"class":"deco deco5"});
			this.deco4.scene = this;
			this.deco4._img = u.ae(this.deco4, "img");
			this.deco4._src = "/img/desktop/playtype_5.jpg";
			this.deco5 = u.ae(this.store, "div", {"class":"deco deco6"});
			this.deco5.scene = this;
			this.deco5._img = u.ae(this.deco5, "img");
			this.deco5._src = "/img/desktop/playtype_6.jpg";
			this.deco_i = 1;
			this.loadDeco = function(queue) {
				if(this.deco_i <= 5) {
					u.preloader(this["deco"+this.deco_i], [this["deco"+this.deco_i]._src], {"callback":this._decoReady});
			...
			this._decoReady = function(queue) {
				u.bug("deco ready:" + queue[0]._image.src);
				this._img.src = queue[0]._image.src;
				this.transitioned = function() {
					u.a.transition(this, "none");
					this.scene.loadDeco();
