...
u.grids = [
	{
		...
		"max_image":1024,
		"etypes":[
			"768-grid_etypes-1.json"
		],
		"daily":[
			"768-grid_daily-1.json"
		],
		"combined":[
	...
	},
	{
		...
		"max_image":1200,
		"etypes":[
			"1024-grid_etypes-1.json"
		],
		"daily":[
			"1024-grid_daily-1.json"
		],
		"combined":[
	...
	},
	{
		...
		"max_image":1600,
		"etypes":[
			"1600-grid_etypes-1.json"
		],
		"daily":[
			"1600-grid_daily-1.json"
		],
		"combined":[
			...
			page.orientationchanged = function(event) {
				if(!page.killed) {
					...
					page.force_update = function() {
						if(page.cN && page.cN.request_url) {
				...
				for(i = 0; node = this.nav_nodes[i]; i++) {
					...
					if(u.hc(node, "projects")) {
						...
						if(!u.hc(node.parentNode, "subjects")) {
							...
							if(u.e.event_pref == "mouse") {
								node.onmouseover = node.mover;
								node.onmouseout = node.mout; 
							}
							else {
								u.e.addStartEvent(node, node.mover);
								u.e.addEndEvent(node, node.mout);
							}
						}
						if(node.submenu) {
	...
	this.init = function(scene) {
		...
		scene.build = function() {
			...
			if(!this.blocks) {
				...
				this.deco2.scene = this;
				this.deco2._img = u.ae(this.deco2, "img");
				this.deco2._src = "/img/desktop/aboutdaily_2.png";
				// 
				this.deco3 = u.ae(this, "div", {"class":"deco deco3"});
...
Util.Objects["competences"] = new function() {
	this.init = function(scene) {
		scene.resized = function() {
			...
			if(this.deco4 && this.deco3._img) {
				u.as(this.deco4, "width", deco4_width+"px", false);
				u.as(this.deco4, "top", deco3_top + (this.deco3._img.offsetHeight - this.deco4.offsetHeight) + "px", false);
		...
		scene.build = function() {
			...
			if(!this.blocks) {
				...
				this.deco2.scene = this;
				this.deco2._img = u.ae(this.deco2, "img");
				this.deco2._src = "/img/desktop/competences_2.png";
				// 
				this.deco3 = u.ae(this, "div", {"class":"deco deco3"});
				this.deco3.scene = this;
				this.deco3._img = u.ae(this.deco3, "img");
				this.deco3._src = "/img/desktop/competences_4.png";
				// 
				this.deco4 = u.ae(this, "div", {"class":"deco deco4"});
				this.deco4.scene = this;
				this.deco4._img = u.ae(this.deco4, "img");
	...
	this.init = function(scene) {
		...
		scene.build = function() {
			...
			if(!this.blocks) {
				...
				this.deco2.scene = this;
				this.deco2._img = u.ae(this.deco2, "img");
				this.deco2._src = "/img/desktop/services_2.jpg";
				// // 
				this.deco3 = u.ae(this, "div", {"class":"deco deco3"});
		...
		scene.loadPrev = function() {
			if(this.current_index > 0) {
				...
				if(u.hc(this._prev, "notloaded")) {
					...
					u.bug("next requested:" + this._prev.item_id)
				}
				else {
					this.resized();
